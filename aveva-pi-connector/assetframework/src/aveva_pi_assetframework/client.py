...
def _s(sess, bearer, api_key, basic_user=None, basic_password=None):
...
def get_point(base: str, server: str, tag: str, *, bearer: str | None = None,
              ...
              basic_password: str | None = None, sess=None, timeout: int = 60) -> dict:
    """`GET /points?path=\\\\{server}\\{tag}` — the point object for one tag
    (incl. its `WebId`, `Path`, `EngineeringUnits`, …). One API call."""
    return request_json(_s(sess, bearer, api_key, basic_user, basic_password), "GET", f"{base}/points",
...
def batch(base: str, requests: dict, *, bearer: str | None = None,
    ...
    return request_json(_s(sess, bearer, api_key, basic_user, basic_password), "POST", f"{base}/batch",
...
def get_asset_database(base: str, server: str, database: str, *, bearer: str | None = None,
    ...
    return request_json(_s(sess, bearer, api_key, basic_user, basic_password), "GET", f"{base}/assetdatabases",
...
def get_database_elements(base: str, database_web_id: str, *, bearer: str | None = None,
                          api_key: str | None = None, basic_user: str | None = None,
              basic_password: str | None = None, sess=None, timeout: int = 60,
    ...
    return request_json(_s(sess, bearer, api_key, basic_user, basic_password), "GET",
