...
pip install aveva_pi_timeseries-2.0.4-py3-none-any.whl        # the Spark connector
```
...
│   ├── pyproject.toml                ←   → wheel: aveva_pi_timeseries-2.0.4
...
pip install /Volumes/<catalog>/<schema>/<volume>/aveva_pi_timeseries-2.0.4-py3-none-any.whl
```
...
**Versions** · `aveva_pi_timeseries` 2.0.4 · `aveva_pi_assetframework` 3.0.2 · each requires only `requests` at runtime.
