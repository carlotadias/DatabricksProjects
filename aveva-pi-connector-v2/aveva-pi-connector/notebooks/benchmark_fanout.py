...
# MAGIC %pip install /Volumes/<catalog>/<schema>/<volume>/aveva_pi_assetframework-3.0.2-py3-none-any.whl /Volumes/<catalog>/<schema>/<volume>/aveva_pi_timeseries-2.0.4-py3-none-any.whl
